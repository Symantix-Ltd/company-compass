...
export async function generateMetadata({ params }: { params: Promise<Params> }) {
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://www.companycompass.co.uk/company-notices/appointment-of-liquidator/${date}`,
    },
  };
}
...
export default async function InsolvencyPage({ params }: { params: Promise<Params> }) {
  ...
  const res = await fetch(
    `https://www.companycompass.co.uk/api/gazette/company-insolvency/appointment-of-liquidator?date=${date}`,
      ...
      <div className="max-w-7xl mx-auto p-6 flex flex-col lg:flex-row gap-8">
        <main className="max-w-4xl mx-auto p-6 bg-white rounded-lg text-gray-900">
          ...
          <NoticeDateNavigation
            baseUrl="/company-notices/appointment-of-liquidator"
            currentDate={date}
