  ...
  export const metadata = {
    ...
    description: description
        ...
        openGraph: {
            title: title,
            description: description,
            url: `https://www.companycompass.co.uk/company-notices/winding-up-order`
          }
  };


export default async function InsolvencyPage() {
  const res = await fetch(`${process.env.BASE_URL}/api/gazette/company-insolvency/winding-up-order`, {
    next: { revalidate },
  });
...
for (const notice of notices) {
  ...
  return (
    ...
    <main className="max-w-4xl mx-auto p-6 bg-white rounded-lg text-gray-900">
      ...
      <h1 className="f-heading-8 mb-4">Winding Up Order</h1>
      <p>Winding Up Order notices published in <a className=" italic" href="https://www.thegazette.co.uk">The Gazette</a></p>
<br/>
