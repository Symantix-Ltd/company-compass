...
export async function generateMetadata({ params }: { params: Promise<Params> }) {
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://www.companycompass.co.uk/company-notices/appointment-of-administrators/${date}`,
    },
  };
}
...
export default async function InsolvencyPage({ params }: { params: Promise<Params> }) {
  ...
  const res = await fetch(
    `https://www.companycompass.co.uk/api/gazette/company-insolvency/appointment-of-administrators?date=${date}`,
      ...
      <div className="max-w-7xl mx-auto p-6 flex flex-col lg:flex-row gap-8">
        ...
        <BreadcrumbsWrapper/>
          ...
          <NoticeDateNavigation
            baseUrl="/company-notices/appointment-of-administrators"
            currentDate={date}
