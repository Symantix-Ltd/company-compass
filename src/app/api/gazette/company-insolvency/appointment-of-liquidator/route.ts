...
export async function GET(request: Request) {
        ...
        try {
          do {
            const feedUrl = `https://www.thegazette.co.uk/all-notices/publish-date/${date}/notice/data.json?categorycode=all&noticetypes=2443&results-page-size=${pageSize}&results-page=${page}`;
